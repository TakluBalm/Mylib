...
string getstr(char *msg, int show, int mode);           // Initialises the string and stores the input from the user
...
void strprint(string str, int show);                    // Prints the content of a string to the screen
